...
export const Route = createFileRoute("/notifications")({
  head: () => ({
    meta: [
      { title: "Notifications — careMP" },
      { name: "description", content: "Health alerts, medication, appointments, family, system." },
    ],
  }),
  component: Notifs,
});
        ...
        <div key={group.group}>
          ...
          <div className="space-y-2">
            {group.items.map((n, i) => (
              ...
              >
                {n.unread && (
                  <span className="absolute left-2 top-1/2 h-1.5 w-1.5 -translate-y-1/2 rounded-full bg-teal" />
                )}
                <div className="pl-3">
