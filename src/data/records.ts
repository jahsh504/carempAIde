...
export const categories: CategoryMeta[] = [
  {
    key: "lab",
    label: "Lab Reports",
    blurb: "Blood tests · Urine tests · Diagnostics",
    icon: "flask",
    tone: "teal",
  ...
  },
  {
    key: "prescriptions",
    label: "Prescriptions",
    blurb: "Current & past doctor prescriptions",
    icon: "pill",
    tone: "emerald",
    lastUpdated: "Today",
  },
  {
    ...
    blurb: "Vaccinations · Insurance · Discharge · Referrals",
    icon: "folder",
    tone: "amber",
...
export const documents: MedicalDoc[] = [
  ...
  },
  {
    ...
    values: [
      ...
      { label: "B12", value: "410 pg/mL", flag: "ok" },
    ],
  },
  {
    id: "d4",
  ...
  },
  {
    ...
    kind: "PDF",
    twin: true,
    medications: ["Atorvastatin 10 mg", "Vitamin D3 60k"],
  },
  {
    id: "d8",
    title: "Post-viral recovery script",
    category: "prescriptions",
    hospital: "Clinic 24",
    doctor: "Dr. Sameer Roy",
    date: "December 2025",
    sortDate: "2025-12-04",
    tag: "Past",
    kind: "Scan",
    twin: false,
    medications: ["Azithromycin 500 mg"],
  },
  {
    id: "d9",
